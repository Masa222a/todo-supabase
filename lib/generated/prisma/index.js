...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/ma/dev/todo-supabase/lib/generated/prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/Users/ma/dev/todo-supabase/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "postgresql://postgres.awnuoczybeyaygicqqni:J!2eh$3dENMarpX@aws-0-ap-northeast-1.pooler.supabase.com:5432/postgres"
      }
    }
  },
  "inlineSchema": "generator client {\n  provider = \"prisma-client-js\"\n  output   = \"../lib/generated/prisma\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel Todo {\n  id        Int      @id @default(autoincrement())\n  title     String\n  content   String\n  createdAt DateTime @default(now())\n  updatedAt DateTime @default(now())\n}\n",
  "inlineSchemaHash": "d52ef3bd8701a7f256ec0ae83b6eada0b93eeddc23ecccac8a79bbc40f9e857d",
  "copyEngine": true
}
